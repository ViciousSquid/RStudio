...
| `runtime.py` | `BigWorldSession` — applies the active set to the live engine (reversible). |
| `entities.py` | `BigWorldSettings` — the map-level opt-in / config entity. |
| `persistence.py` | Config extraction, save hygiene, UUID-stability verification. |
